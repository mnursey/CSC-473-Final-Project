...
public class SpringTableAgent : Agent
{
    ...
    public List<ArmController> arms = new List<ArmController>();
    ...
    public override void CollectObservations(VectorSensor sensor)
    {
        ...
        foreach (ArmController arm in arms)
        {
            ...
            sensor.AddObservation(m_OrientationCube.transform.InverseTransformDirection(arm.GetVelocity()));
    ...
    public override void OnActionReceived(ActionBuffers actionBuffers)
    {
        ...
        {
            arms[i].UpdateSpringForce(continuousActions[i]);
        }
    }
